...
namespace
{
void set_armor_priorities(std::list<auto_aim::Armor> & armors)
{
  ...
  omni_target_priority_{ArmorPriority::fifth}
{
  ...
  v1_base_ = yaml["v1_base"].as<double>();
  v2_base_ = yaml["v2_base"].as<double>();
  v1_outpost_ = yaml["v1_outpost"].as<double>();
  v2_outpost_ = yaml["v2_outpost"].as<double>();
}
...
bool Tracker::set_target(std::list<Armor> & armors, std::chrono::steady_clock::time_point t)
{
  ...
  if (is_balance) {
    ...
    target_ = Target(armor, t, 0.2, 2, P0_dig, v1_base_, v2_base_, v1_outpost_, v2_outpost_);
  }
    ...
    target_ = Target(
      matched_armors.front(), t, 0.2765, 3, P0_dig, v1_base_, v2_base_, v1_outpost_,
      v2_outpost_);
    ...
    target_ = Target(armor, t, 0.3205, 3, P0_dig, v1_base_, v2_base_, v1_outpost_, v2_outpost_);
  }

  else {
    solver_.solve(armor);
    Eigen::VectorXd P0_dig{{1, 64, 1, 64, 1, 64, 0.4, 100, 1, 1, 1, 0, 0}};
    target_ = Target(armor, t, 0.2, 4, P0_dig, v1_base_, v2_base_, v1_outpost_, v2_outpost_);
  }
