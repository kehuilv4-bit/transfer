...
public:
  ...
  Target(
    ...
    Eigen::VectorXd P0_dig, double v1_base, double v2_base, double v1_outpost,
    double v2_outpost);
...
private:
  ...
  double v1_base_{100.0};
  double v2_base_{400.0};
  double v1_outpost_{10.0};
  double v2_outpost_{0.1};
